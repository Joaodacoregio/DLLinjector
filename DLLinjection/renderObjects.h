...
struct Drop : public RenderObject {
	...
	struct DropEntity* ptrThre; //0x0010, corrigido para manter o padr�o de nomea��o
	char pad_0018[24];         //0x0018
	float X;                    //0x0030
	char pad_0034[4];           //0x0034
	float Y;                    //0x0038
	char pad_003C[52];          //0x003C
	struct NameClass* namePtr; //0x0070, descomente se necess�rio
};
...
struct Player : public RenderObject {                           //Seria player um objeto renderizavel?
	...
	char Padding2[184]; // Padding para alcan�ar o pr�ximo elemento
	// Element Offset: 348
